...
\setuphead[subsubsection][style=\bf, color=titlegrey, align=middle, topspace=0]
...
[headstyle=bold, style=normal,
  location=hanging, width=25mm, distance=14mm, margin=0cm]
...
\setupthinrules[width=13em] % width of horizontal rules
